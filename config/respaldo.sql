...
MySQL - 5.6.24-log : Database - dbsuper
*********************************************************************
*/
...
insert  into `tab_categorias`(`catego_id`,`catego_descripcion`) values 
(0,NULL),
(1,'Electrodomésticos'),
...
insert  into `tab_marcas`(`marca_id`,`marca_descripcion`) values 
(1,'Kellogg\'s'),
(2,'Coca-Cola'),
(3,'Nestlé'),
(4,'P&G'),
...
CREATE TABLE `tab_productos` (
  ...
  `pro_especifica` text CHARACTER SET utf8mb4,
...
insert  into `tab_productos`(`pro_id`,`pro_descripcion`,`pro_precio_c`,`pro_precio_v`,`pro_stock`,`pro_fecha_elab`,`pro_nivel_azucar`,`pro_aplica_iva`,`pro_especifica`,`pro_imagen`,`marca_id`,`catego_id`) values 
(1,'Lavadora LG',599.99,799.99,5,'2023-06-01',NULL,1,'Capacidad de 10 kg, 1200 RPM','lavadora.jpeg',4,1),
(2,'Leche Alpura',2.99,4.99,20,'2023-06-02',NULL,1,'Leche entera, 1 litro','leche.jpeg',3,2),
(3,'iPhone 13 Pro',1099.00,1299.99,8,'2023-06-03',NULL,1,'Pantalla Super Retina XDR de 6.1\", 128GB Almacenamiento','iphone.jpeg',2,3),
(4,'Crema Facial Nivea',9.99,14.99,15,'2023-06-04',NULL,1,'Hidratante, 50 ml','nivea.jpeg',5,4),
(5,'Sartén antiadherente',19.99,29.99,12,'2023-06-05',NULL,1,'Diámetro de 26 cm, mango ergonómico','sarten.jpeg',1,5),
(7,'laaa',30.00,20.00,10,'2023-07-30','B',1,'leeeeeeee','7042.jpg',4,5),
(5456,'dsgdgdafh',10.00,50.00,2,'2023-07-10','M',1,'fhsdfj','3483.jpg',1,2);
